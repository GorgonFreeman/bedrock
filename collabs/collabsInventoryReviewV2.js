...
// curl localhost:8000/collabsInventoryReviewV2 -H "Content-Type: application/json" -d '{ "region": "au", { "options": "minReportableDiff": 3, "shopifyVariantsFetchQueries": ["published_status:published", "product_publication_status:approved"] } }'
// curl localhost:8000/collabsInventoryReviewV2 -H "Content-Type: application/json" -d '{ "region": "us", { "options": "minReportableDiff": 3, "shopifyVariantsFetchQueries": ["published_status:published", "product_publication_status:approved", "tag_not:not_for_radial"] } }'
// curl localhost:8000/collabsInventoryReviewV2 -H "Content-Type: application/json" -d '{ "region": "uk", { "options": "minReportableDiff": 3, "shopifyVariantsFetchQueries": ["published_status:published", "product_publication_status:approved"] } }'